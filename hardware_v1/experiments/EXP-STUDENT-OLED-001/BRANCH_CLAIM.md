# Branch claim — `hardware/exp-student-oled`

**Experiment:** `EXP-STUDENT-OLED-001`  
...
This branch isolates the comparison track for: **Student OLED panel vs IPS**.

Canonical package: `hardware_v1/experiments/EXP-STUDENT-OLED-001/COMPARISON_PACKAGE.md`
