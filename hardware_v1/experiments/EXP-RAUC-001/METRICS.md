...
| Metric | Value | State |
|---|---|---|
| `update_success_rate` | — | PENDING_PHYSICAL_MEASUREMENT |
| `rollback_success_rate` | — | PENDING_PHYSICAL_MEASUREMENT |
| `brick_rate` | — | PENDING_PHYSICAL_MEASUREMENT |
