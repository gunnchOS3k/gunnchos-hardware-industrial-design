# Branch claim — `hardware/exp-rings-inductive-charge`

**Experiment:** `EXP-RINGS-INDUCTIVE-001`  
...
This branch isolates the comparison track for: **Inductive ring charge vs magnetic cradle contacts**.

Canonical package: `hardware_v1/experiments/EXP-RINGS-INDUCTIVE-001/COMPARISON_PACKAGE.md`
