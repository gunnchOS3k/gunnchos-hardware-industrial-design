...
| Metric | Value | State |
|---|---|---|
| `gesture_f1` | — | PENDING_PHYSICAL_MEASUREMENT |
| `skin_current_ua` | — | PENDING_PHYSICAL_MEASUREMENT |
| `false_positive_rate` | — | PENDING_PHYSICAL_MEASUREMENT |
| `privacy_review_pass` | — | PENDING_PHYSICAL_MEASUREMENT |
