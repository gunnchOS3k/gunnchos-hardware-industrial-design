# Branch claim — `hardware/exp-com-hpc-modular-product`

**Experiment:** `EXP-COM-HPC-MODULAR-001`  
...
This branch isolates the comparison track for: **COM-HPC modular product architecture vs custom motherboard mainline**.

Canonical package: `hardware_v1/experiments/EXP-COM-HPC-MODULAR-001/COMPARISON_PACKAGE.md`
