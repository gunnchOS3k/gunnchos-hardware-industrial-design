# Branch claim — `hardware/exp-dsxl-oled-hybrid`

**Experiment:** `EXP-DSXL-OLED-HYBRID-001`  
...
This branch isolates the comparison track for: **DS-XL OLED+IPS hybrid vs dual IPS**.

Canonical package: `hardware_v1/experiments/EXP-DSXL-OLED-HYBRID-001/COMPARISON_PACKAGE.md`
