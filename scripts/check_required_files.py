...
REQUIRED = [
    ...
    "scripts/validate_digital_manufacturing.py",
    ...
    "mechanical_correctness/README.md",
    "mechanical_correctness/MECHANICAL_CORRECTNESS_STATUS.md",
    "mechanical_correctness/device_mechanical_targets.json",
    "printability/README.md",
    "printability/PRINTABILITY_STATUS.md",
    "dvt/README.md",
    "dvt/DVT_STATUS.md",
    "pvt/README.md",
    "pvt/PVT_STATUS.md",
    ...
    "vendor_labs/README.md",
    "production_backlog/MECHANICAL_PRINT_DVT_PVT_CERTIFICATION_ISSUES.md",
    "scripts/validate_mechanical_correctness.py",
    "scripts/validate_printability.py",
    "scripts/validate_dvt_pvt_readiness.py",
    "scripts/validate_certification_readiness.py",
    "scripts/validate_production_release_gate.py",
]
