#!/usr/bin/env python3
"""Generate docs/HARDWARE_PACKAGE_INDEX.md from repo structure."""
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
OUT = ROOT / "docs" / "HARDWARE_PACKAGE_INDEX.md"

CONTENT = """# Hardware Package Index
...
- [Fabrication checklist](../pcb/FABRICATION_OUTPUTS_CHECKLIST.md)

## For enclosure prototype vendor
- [CAD](../cad/README.md)
- [OpenSCAD source](../cad/openscad/)
...
- [Battery UN38.3](../compliance/UN38_3_BATTERY_PLAN.md)
...
## What is ready now
- EVT-1 prototype RFQ documentation package
- Vendor review checklist and RFQ templates
- Schematic skeleton review package
- CAD source and export path (STL pending OpenSCAD CLI)
- BOM and power budget templates
- Compliance planning matrix

## What is not ready yet
- Final PCB layout and verified Gerbers
- Pick-and-place and assembly outputs
- Physical prototype and test data
- Compliance pre-scan and FCC/CE approval
- Battery certification
- DVT/PVT manufacturing release
"""
