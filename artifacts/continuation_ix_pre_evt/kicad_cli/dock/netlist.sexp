(export
	...
	(components
		...
		(comp
			...
			(fields
				...
				(field
					(name "Role") "ETHERNET")
				(field
					(name "Footprint") "gunnchos_production:QFN-48-1EP_6x6mm_P0.4mm")
				(field
					(name "Datasheet")
				)
				(field
		...
		(comp
			(ref "UHUB1")
			(value "VL817")
			(footprint "gunnchos_production:QFN-48-1EP_7x7mm_P0.5mm")
			(fields
				(field
					(name "ContIX") "PRODUCTION")
				(field
				...
				(field
					(name "Role") "USB_HUB")
				(field
					(name "Footprint") "gunnchos_production:QFN-48-1EP_7x7mm_P0.5mm")
				(field
					(name "Datasheet")
				)
				(field
		...
		(comp
			(ref "URET1")
			(value "JHL9040R")
			(footprint "gunnchos_production:JHL9040R_ROLE_envelope")
			(fields
				(field
					(name "ContIX") "PRODUCTION")
				(field
				...
				(field
					(name "Footprint") "gunnchos_production:JHL9040R_ROLE_envelope")
				(field
					(name "Datasheet")
				)
				(field
			...
			(tstamps "eabd80c2-388a-0abd-c9f4-bd446ed44381")
			(units
				(unit
					(name "A")
					(pins
		...
		(comp
			(ref "UUSB4")
			(value "JHL8440")
			(footprint "gunnchos_production:JHL8440_ROLE_envelope")
			(fields
				(field
					(name "ContIX") "PRODUCTION")
				(field
				...
				(field
					(name "NDA") "PACKAGE_BALL_MAP")
				(field
					(name "Footprint") "gunnchos_production:JHL8440_ROLE_envelope")
				(field
					(name "Datasheet")
				)
				(field
