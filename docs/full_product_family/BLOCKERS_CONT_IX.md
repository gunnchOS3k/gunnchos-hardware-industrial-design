...
## DIGITAL
- Handheld MLP/production A/B/recovery disk images still unproven vs Outcome A 5.0 GiB budgets — `NPI_DEFECT-HANDHELD-IMAGE-SLOT-FIT-001` **OPEN** (stub realm sizes measured via device-os #107; `npi/phase_xv/handheld_storage_headroom/`)
