# HISTORICAL — pre–WP-012 hardware README front matter

**Label:** HISTORICAL / LEGACY

Older root README mixed conceptual EVT-0 language with later EVT/RFQ package material. Preserved for history; Cycle 3A current claims live in the root README.
