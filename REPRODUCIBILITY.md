        # Reproducibility — gunnchos Hardware Industrial Design

        ## Clone / setup / run

        ```bash
        git clone https://github.com/gunnchOS3k/{name}.git
cd gunnchos-hardware-industrial-design
...
# Expected: CI smoke pass; tests pass or documented skip
        ...
        **Real today:** ID docs, BOM drafts, ergonomics notes

        **Synthetic / demo-only:** Render placeholders

        **Planned:** Prototype fabrication run

        **Not claimed:** Mass-manufactured certified hardware
