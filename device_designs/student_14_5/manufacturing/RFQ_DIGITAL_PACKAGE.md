# RFQ digital package — student_14_5 (DO NOT SUBMIT)
...
4. Panelization: carrier panel with mouse-bites.
5. NDA: provide COM-HPC Mini mating connector MPN + pin map under NARROW_NDA.
