# CM README — student_14_5 (Cont IX digital RFQ pack)

PHYSICAL_EXECUTION_FREEZE ACTIVE — **do not submit** to fab/CM yet.

## Package contents (pointers)
- Gerbers/drill/PnP/STEP/PDF: `device_designs/student_14_5/manufacturing/cont_ix_release/`
- BOM/AVL: `device_designs/student_14_5/manufacturing/ASSEMBLY_BOM.csv`
