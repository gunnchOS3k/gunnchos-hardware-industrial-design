# CM README — dock (Cont IX digital RFQ pack)

PHYSICAL_EXECUTION_FREEZE ACTIVE — **do not submit** to fab/CM yet.

## Package contents (pointers)
- Gerbers/drill/PnP/STEP/PDF: `device_designs/dock/manufacturing/cont_ix_release/`
- BOM/AVL: `device_designs/dock/manufacturing/ASSEMBLY_BOM.csv`
